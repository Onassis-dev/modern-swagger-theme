export const customCss = `@media only screen and (prefers-color-scheme: dark) {
    a {
      color: #8c8cfa;
    }
    ...
    .swagger-ui .opblock-tag {
      ...
      grid-template-columns: 1fr 0px auto auto !important;
    ...
    .swagger-ui .opblock-tag-section.is-open .expand-operation svg {
    ...
    .swagger-ui .opblock-summary::before {
      ...
      width: 1px !important; 
      background-color:rgb(65, 66, 69) !important; 
}
